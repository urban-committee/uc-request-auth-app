package com.urban.committee.jwtTokenUtils;

import java.security.Key;
import java.util.Date;

import com.urban.committee.security.UCUserDetailsImpl;
...
public class JwtTokenUtils {
    ...
    public String generateJwtToken(Authentication authentication) {
        ...
        UCUserDetailsImpl userPrincipal = (UCUserDetailsImpl) authentication.getPrincipal();
